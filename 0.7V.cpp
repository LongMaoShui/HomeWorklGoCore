...
#include<string.h>	 //Core Ultra Max PW---Dev 0.7V
#include<stdio.h>	 //更新说明:退出程序写完了 
#include<time.h>	 
...
void Homev07(string mode,string FExit,string RExit)
{
	char switch_mode;
	if(mode=="WelcomeHome")
	{
		system("title HomeWorkGo主页");
		cout<<"HomeWorkGo            一个简洁而朴实无华的写作业神器!             (Dev V0.7)"<<endl;
	  ...
	  /*cout<<"                                                                            "<<endl;*/ //比较行 
		...
		switch(switch_mode)
		{
			case 'I':Homev07("FJZ_I","NotServer","NotServer");
					 int_countF();break;
			case 'i':Homev07("FJZ_I","NotServer","NotServer");
					 int_countF();break;
			case 'E':Homev07("ExitF","NotServer","NotServer");
					 exit_code();break;
			case 'e':Homev07("ExitF","NotServer","NotServer");
					 exit_code();break;					 
		}
	...
	if(mode=="Welcome")
	{
		...
		system("cls");
		Homev07("WelcomeHome","NotSevrer","NotSevrer");
	}
	if(mode=="FJZ_I")
	{
...
int main()
{
	Homev07("Welcome","NotSevrer","NotSevrer");
	return 0;
}
