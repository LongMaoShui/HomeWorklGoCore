...
#include<string.h>	 //Core Ultra Max PW---Canny 1.3V
...
void Homev013(string mode,string FExit,string RExit)
{
	int n;
	char switch_mode;
	if(mode=="WelcomeHome")
	{
		...
		cout<<"HomeWorkGo            一个简洁而朴实无华的写作业神器!           (Canny V1.3)"<<endl;
	  ...
	  /*cout<<"                                                                            "<<endl;*/ //比较行 
		...
		{
			case 'I':Homev013("int_countF_Start","NotServer","NotServer");
					 int_countF();break;
			case 'i':Homev013("int_countF_Start","NotServer","NotServer");
					 int_countF();break;
			case 'E':exit_code();break;
			case 'e':exit_code();break;	
			case 'Z':Homev013("Zan_Start","NotServer","NotServer");
					 ZanF();break;
			case 'z':Homev013("Zan_Start","NotServer","NotServer");
					 ZanF();break;	
			case 'D':Homev013("double_countF_Start","NotServer","NotServer");
					 double_countF();break;
			case 'd':Homev013("double_countF_Start","NotServer","NotServer");
					 double_countF();break;	
			case 'F':Homev013("float_countF_Start","NotServer","NotServer");
					 float_countF();break;
			case 'f':Homev013("float_countF_Start","NotServer","NotServer");
					 float_countF();break;		
			case 'J':system("cls");
	...
	if(mode=="Welcome")
	{
		...
		system("cls");
		Homev013("WelcomeHome","NotSevrer","NotSevrer");
	}
...
int main()
{
	Homev013("Welcome","NotSevrer","NotSevrer");
	return 0;
}
