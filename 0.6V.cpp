...
#include<string.h>	 //Core Ultra Max PW---Dev 0.6V
#include<stdio.h>	 //更新说明:真的写完了int_countF() 
#include<time.h>
#include<windows.h>
using namespace std;
void int_countF()
...
void Homev06(string mode,string FExit,string RExit)
{
	char switch_mode;
	if(mode=="WelcomeHome")
	{
		system("title HomeWorkGo主页");
		cout<<"HomeWorkGo            一个简洁而朴实无华的写作业神器!             (Dev V0.6)"<<endl;
	  ...
	  /*cout<<"                                                                            "<<endl;*/ //比较行 
		...
		switch(switch_mode)
		{
			case 'I':Homev06("FJZ_I","NotServer","NotServer");
					 int_countF();break;
			case 'i':Homev06("FJZ_I","NotServer","NotServer");
					 int_countF();break;
		}
	...
	if(mode=="Welcome")
	{
		...
		system("cls");
		Homev06("WelcomeHome","NotSevrer","NotSevrer");
	}
	if(mode=="FJZ_I")
	{
...
int main()
{
	Homev06("Welcome","NotSevrer","NotSevrer");
	return 0;
}
