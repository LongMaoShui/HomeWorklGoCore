...
#include<string.h>	 //Core Ultra Max PW---Canny 0.9V
#include<stdio.h>	 //更新说明:改了一点点Debug 
#include<time.h>	 
...
void Homev09(string mode,string FExit,string RExit)
{
	char switch_mode;
	if(mode=="WelcomeHome")
	{
		system("title HomeWorkGo主页");
		cout<<"HomeWorkGo            一个简洁而朴实无华的写作业神器!           (Canny V0.9)"<<endl;
	  ...
	  /*cout<<"                                                                            "<<endl;*/ //比较行 
		...
		switch(switch_mode)
		{
			case 'I':Homev09("int_countF_Start","NotServer","NotServer");
					 int_countF();break;
			case 'i':Homev09("int_countF_Start","NotServer","NotServer");
					 int_countF();break;
			case 'E':Homev09("ExitF","NotServer","NotServer");
					 exit_code();break;
			case 'e':Homev09("ExitF","NotServer","NotServer");
					 exit_code();break;					 
		}
	...
	if(mode=="Welcome")
	{
		...
		system("cls");
		Homev09("WelcomeHome","NotSevrer","NotSevrer");
	}
...
int main()
{
	Homev09("Welcome","NotSevrer","NotSevrer");
	return 0;
}
